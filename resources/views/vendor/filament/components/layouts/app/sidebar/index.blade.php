<aside x-data="{}"
    ...
    @else
        x-cloak="-lg"
        x-bind:class="$store.sidebar.isOpen ? 'filament-sidebar-open translate-x-0 shadow-2xl' : '-translate-x-full lg:translate-x-0 lg:shadow-2xl rtl:lg:-translate-x-0 rtl:translate-x-full'" @endif
    @class([
    ...
    <nav class="flex-1 py-6 overflow-x-hidden overflow-y-auto filament-sidebar-nav" id="style-1">
